...
def process_image_resumes(folder_path):
...
def process_pdf_resumes(folder_path):
...
def main():
    process_image_resumes(INPUT_PATH_IMAGE)
    # print(extract_text_from_image(os.path.join(INPUT_PATH_IMAGE, "resume_02.jpg")))
